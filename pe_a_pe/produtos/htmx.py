...
class HTMXProdutoListView(generic.ListView):
...
class HTMXProdutoCreateView(generic.CreateView):
    model = models.Produto
    form_class = forms.ProdutoForm
...
class HTMXProdutoDeleteView(generic.DeleteView):
    model = models.Produto
    success_url = reverse_lazy("produtos_Produto_htmx_list")
